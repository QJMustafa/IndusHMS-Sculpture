...
function ext_addEvent(id, relationId) {
    var _obj = $('#' + id);
    _obj.attr({
        'fill': ext_config[id].upColor,
        'fill-opacity': ext_config[id].upOpacity,
        'stroke': ext_config[id].outlineUpColor,
        'stroke-opacity': ext_config[id].outlineUpOpacity
    });
    _obj.attr({
        'cursor': 'default'
    });
    if (ext_config[id].enable == !0) {
        if (isTouchEnabled()) {
            _obj.on('touchstart', function (e) {
                ...
                $('#' + id).css({
                    'fill': ext_config[id].overColor,
                    'fill-opacity': ext_config[id].downOpacity,
                    'stroke': ext_config[id].outlineDownColor,
                    'stroke-opacity': ext_config[id].outlineDownOpacity
                });
            ...
            _obj.on('touchend', function () {
                ...
                } else if (ext_config[id].target == 'modal') {
                    jQuery(ext_config[id].url).modal("show")
                }
            })
        }
        _obj.attr({
        ...
        _obj.hover(function () {
            ...
            _obj.css({
                'fill': ext_config[id].overColor,
                'fill-opacity': ext_config[id].overOpacity,
                'stroke': ext_config[id].outlineOverColor,
                'stroke-opacity': ext_config[id].outlineOverOpacity
            })
        }, function () {
            $('#organs-tip').hide();
            $('#' + id).css({
...
function int_addEvent(id, relationId) {
    var _obj = $('#' + id);
    _obj.attr({
        'fill': int_config[id].upColor,
        'fill-opacity': int_config[id].upOpacity,
        'stroke': int_config[id].outlineUpColor,
        'stroke-opacity': int_config[id].outlineUpOpacity
    });
    _obj.attr({
        'cursor': 'default'
    });
    if (int_config[id].enable == !0) {
        if (isTouchEnabled()) {
            _obj.on('touchstart', function (e) {
                var touch = e.originalEvent.touches[0];
                var x = touch.pageX + 10,
                ...
                y = (y + tiph > $(document).scrollTop() + $(window).height()) ? $(document).scrollTop() + $(window).height() - tiph - 10 : y
                $('#' + id).css({
                    'fill': int_config[id].overColor,
                    'fill-opacity': int_config[id].downOpacity,
                    'stroke': int_config[id].outlineDownColor,
                    'stroke-opacity': int_config[id].outlineDownOpacity
                });
        ...
        _obj.hover(function () {
            ...
            _obj.css({
                'fill': int_config[id].overColor,
                'fill-opacity': int_config[id].overOpacity,
                'stroke': int_config[id].outlineOverColor,
                'stroke-opacity': int_config[id].outlineOverOpacity
            })
        }, function () {
            $('#organs-tip').hide();
            $('#' + id).css({
...
function dynamicext_addEvent(id) {
    ...
    if (ext_spots.spots[id].enable == !0) {
        if (isTouchEnabled()) {
            obj.on('touchstart', function (e) {
                ...
                y = (y + tiph > $(document).scrollTop() + $(window).height()) ? $(document).scrollTop() + $(window).height() - tiph - 10 : y
                $('#' + id).css({
                    'fill': ext_spots.spots[id].downColor,
                    'fill-opacity': ext_spots.spots[id].downOpacity,
                    'stroke': ext_spots.spots[id].outlineDownColor,
                    'stroke-opacity': ext_spots.spots[id].outlineDownOpacity
                });
            ...
            obj.on('touchend', function () {
                $('#' + id).css({
                    'fill': ext_spots.spots[id].upColor,
                    'fill-opacity': ext_spots.spots[id].upOpacity,
                    'stroke': ext_spots.spots[id].outlineUpColor,
                    'stroke-opacity': ext_spots.spots[id].outlineUpOpacity
                });
        ...
        obj.hover(function () {
            $('#organs-tip').show().html(ext_spots.spots[id].hover);
            obj.css({
                'fill': ext_spots.spots[id].overColor,
                'fill-opacity': ext_spots.spots[id].overOpacity,
                'stroke': ext_spots.spots[id].outlineOverColor,
                'stroke-opacity': ext_spots.spots[id].outlineOverOpacity
            })
        }, function () {
            $('#organs-tip').hide();
            obj.css({
...
function dynamicint_addEvent(id) {
    ...
    if (int_spots.spots[id].enable == !0) {
        if (isTouchEnabled()) {
            obj.on('touchstart', function (e) {
                var touch = e.originalEvent.touches[0];
                var x = touch.pageX + 10,
                ...
                y = (y + tiph > $(document).scrollTop() + $(window).height()) ? $(document).scrollTop() + $(window).height() - tiph - 10 : y
                $('#' + id).css({
                    'fill': int_spots.spots[id].downColor,
                    'fill-opacity': int_spots.spots[id].downOpacity,
                    'stroke': int_spots.spots[id].outlineDownColor,
                    'stroke-opacity': int_spots.spots[id].outlineDownOpacity
                });
            ...
            obj.on('touchend', function () {
                $('#' + id).css({
                    'fill': int_spots.spots[id].upColor,
                    'fill-opacity': int_spots.spots[id].upOpacity,
                    'stroke': int_spots.spots[id].outlineUpColor,
                    'stroke-opacity': int_spots.spots[id].outlineUpOpacity
                });
        ...
        obj.hover(function () {
            $('#organs-tip').show().html(int_spots.spots[id].hover);
            obj.css({
                'fill': int_spots.spots[id].overColor,
                'fill-opacity': int_spots.spots[id].overOpacity,
                'stroke': int_spots.spots[id].outlineOverColor,
                'stroke-opacity': int_spots.spots[id].outlineOverOpacity
            })
        }, function () {
            $('#organs-tip').hide();
            obj.css({
...
var int_config = {
    ...
    'int_2': {
        'hover': '<b><u>LARYNX</u></b><br>Write any text and load images<br><img src="assets/images/hover.png">',
        'enable': !0,
        'url': 'NA/',
        'target': 'same_window',
        'upColor': '#ff8080',
    ...
    'int_3': {
        'hover': '<b><u>THYROID</u></b><br>Write any text and load images<br><img src="assets/images/hover.png">',
        'enable': !0,
        'url': 'NA/',
        'target': 'same_window',
        'upColor': '#ff8080',
    ...
    'int_5': {
        'hover': '<b><u>LUNGS</u></b><br>Write any text and load images<br><img src="assets/images/hover.png">',
        'enable': !0,
        'url': 'NA/',
        'target': 'same_window',
        'upColor': '#ff8080',
    ...
    'int_6': {
        'hover': '<b><u>STOMACH</u></b><br>Write any text and load images<br><img src="assets/images/hover.png">',
        'enable': !0,
        'url': 'NA/',
        'target': 'same_window',
        'upColor': '#ff8080',
    ...
    'int_8': {
        'hover': '<b><u>SPLEEN</u></b><br>Write any text and load images<br><img src="assets/images/hover.png">',
        'enable': !0,
        'url': 'NA/',
        'target': 'same_window',
        'upColor': '#ff8080',
    ...
    'int_11': {
        'hover': '<b><u>SMALL INTESTINE</u></b><br>Write any text and load images<br><img src="assets/images/hover.png">',
        'enable': !0,
        'url': 'NA/',
        'target': 'same_window',
        'upColor': '#ff8080',
...
var int_spots = {
    'spots': [{
        'hover': '<u><b>Appendix</b></u><br>Add unlimited number of spots<br>anywhere on the diagram and<br>customize its colors and size and<br>link it to any webpage.',
        'pos_X': 371,
        'pos_Y': 616,
        'diameter': 30,
        'upColor': '#FF0000',
